            ...
            <>
				...
				<View style = {section}>
                    ...
                    <View style = {infoContainer}>
                        <Text style = {balanceHeading}>Your LTC balance will be</Text>
                        <View>
                            <Text style = {{color: 'white', fontSize: 19, fontFamily: 'Armegoe', position: 'relative', top: hp('2.5%')}}>6.43 LTC</Text>
                            <Text style = {{color: 'white', fontSize: 19, fontFamily: 'Armegoe', textAlign: 'right'}}>4.384 AET</Text>
                        </View>
                    </View>
                    <View style = {infoContainer}>
                        ...
                        <View>
                            <Text style = {{color: 'white', fontSize: 19, fontFamily: 'Armegoe', position: 'relative', top: hp('2.5%')}}>4.384 AET</Text>
                            <Text style = {{color: 'white', fontSize: 19, fontFamily: 'Armegoe', textAlign: 'right'}}>6.43 LTC</Text>
                        </View>
                    </View>
				</View>
            </>

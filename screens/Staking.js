...
export default class Staking extends Component {
    ...
    handleStake(){
        /* if(this.state.amount >= this.state.aetBalance) {
            alert('Insufficient AET balance');
        }
            ...
            privateKey = CryptoJS.AES.encrypt(privateKey, '7d0d81d0919f4f05b9ab6634be01ee73').toString();
        ...
        return (
            <>
				...
				<View style = {section}>
                    ...
                    <Input inputStyle = {inputBox} inputContainerStyle = {{borderBottomWidth: 1, borderBottomColor: 'white'}} value = {this.state.amount} onChangeText = {this.handleAmount} placeholder = "Enter Amount to Stake" placeholderTextColor = "white" keyboardAppearance = "dark" keyboardType = "numeric"/>
                	</View>
					<TouchableOpacity style = {button} activeOpacity = {0.6} disabled = {isLoading} onPress = {this.handleStake}>
